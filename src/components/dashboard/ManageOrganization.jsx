...
export default  function ManageOrganization({myOrganizations}){
    ...
    return(
      <Fragment>
        <div className="bg-gray-700 p-2 select-none">
          ...
          {myOrganizations.length>=1?<div className="block lg:grid grid-cols-2 text-slate-400">
            { myOrganizations.map(org => (
              <Link href={`/dashboard/${org.organization_name}`} className="p-4 my-3 block bg-gray-600 w-[90%] lg:w-[75%]  mx-auto cursor-pointer shadow-lg border-gray-500 rounded">
                ...
                <hr className="block w-full border-b border-gray-400 my-1"/>
